...
def t450006_x9002(action3=13010000):
    """State 0,1"""
...
def t450006_x9003(z1=150, goods1=2141, val1=14):
    """State 0,18"""
    ...
    call = t450006_x9005(goods2=150, goods3=0)
    if call.Get() == 1:
        """State 10,19"""
        ...
        call = t450006_x9005(goods2=150, goods3=1)
        if call.Get() == 1:
            """State 12,9"""
            if GetEstusAllocation(0) + GetEstusAllocation(1) < val1:
                ...
                if ComparePlayerInventoryNumber(3, goods1, 2, 0, 0) == 1:
                    ...
                    call = t450006_x9006(action2=12002003)
                    if call.Get() == 0:
                        """State 4,6"""
                        # goods:2141:Estus Shard
                        ...
                        assert t450006_x9007(action1=13002010)
                        """State 22"""
                        assert t450006_x9008(val2=14)
                    elif call.Done():
                        """State 5"""
                        pass
                else:
                    ...
                    assert t450006_x9007(action1=13002011)
            else:
                """State 8,17"""
                # action:13002012:"Cannot reinforce further"
                assert t450006_x9007(action1=13002012)
        elif call.Done():
            """State 13,21"""
            # action:13002014:"No <?gdsparam@190?> in inventory"
            assert t450006_x9007(action1=13002014)
    elif call.Done():
        """State 11,20"""
        # action:13002013:"No <?gdsparam@150?> in inventory"
        assert t450006_x9007(action1=13002013)
    """State 23"""
    return 0

def t450006_x9004(z2=150):
    """State 0,6"""
    # goods:151:Estus Flask, goods:153:Estus Flask+1, goods:155:Estus Flask+2, goods:157:Estus Flask+3, goods:159:Estus Flask+4, goods:161:Estus Flask+5, goods:163:Estus Flask+6, goods:165:Estus Flask+7, goods:167:Estus Flask+8, goods:169:Estus Flask+9, goods:171:Estus Flask+10, goods:150:Estus Flask, goods:152:Estus Flask+1, goods:154:Estus Flask+2, goods:156:Estus Flask+3, goods:158:Estus Flask+4, goods:160:Estus Flask+5, goods:162:Estus Flask+6, goods:164:Estus Flask+7, goods:166:Estus Flask+8, goods:168:Estus Flask+9, goods:170:Estus Flask+10
    call = t450006_x9005(goods2=150, goods3=0)
    if call.Get() == 1:
...
def t450006_x9005(goods2=150, goods3=_):
    """State 0,1"""
...
def t450006_x9006(action2=12002003):
    """State 0,1"""
    # action:12002003:"Use <?gdsparam@2141?> to reinforce Estus Flask?"
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            if GetEventStatus(2051) == 1 or IsMultiplayerInProgress() == 1:
                """State 21,27"""
                assert t450006_x9002(action3=13010000)
            else:
                """State 17"""
            ...
            """State 20,26"""
            assert t450006_x9004(z2=150) and not (CheckSpecificPersonMenuIsOpen(8, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0))
        elif GetTalkListEntryResult() == 8:
            """State 19,25"""
            # goods:2141:Estus Shard
            assert (t450006_x9003(z1=150, goods1=2141, val1=14) and not (CheckSpecificPersonMenuIsOpen(8,
